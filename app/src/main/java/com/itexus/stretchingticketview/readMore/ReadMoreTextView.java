package com.itexus.stretchingticketview.readMore;
...
import com.itexus.stretchingticketview.R;
...
public class ReadMoreTextView extends TextView {
    ...
    private class ReadMoreClickableSpan extends ClickableSpan {
        ...
        public void onClick(View widget) {
            if (readClickListener != null)
                readClickListener.onReadClick(readMore);
            readMore = !readMore;
            setText();
        }
    ...
    public void setOnReadMoreListener(ReadClickListener span) {
        readClickListener = span;
    }

    public interface ReadClickListener {
        void onReadClick(Boolean show);
    }
